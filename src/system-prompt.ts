...
export function buildSystemPrompt(settings: AppSettings): string {
  return [
    ...
    "",
    "## Ferramentas",
    "- `browser_action` — navigate, click, type, keyPress, scroll, extractPage, wait. Toda chamada devolve o que realmente aconteceu, inclusive falhas. Leia o resultado antes do próximo passo.",
