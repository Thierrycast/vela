...
> **Status em 2026-09-15** — revisão de uma sessão posterior, que corrigiu boa parte do que este
> relatório encontrou. Mantido como registro histórico (não apagado) porque ainda tem achados em
> aberto.
>
...
> - 🟡 Indicador visual da voz dessincronizado do áudio — **não confirmado corrigido**. A revisão
>   posterior mexeu na velocidade e no rascunho da transcrição, não neste sincronismo especificamente;
